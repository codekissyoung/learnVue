...
// 获取属性描述符 (这些方法在 Object 构造函数上，不是原型上)
...
console.log("=== 原型链查找演示 ===");
console.log("1. 在 arr 实例上找 hasOwnProperty:", arr.hasOwnProperty ? "❌ 没找到" : "❌ 没找到");
console.log("2. 在 Array.prototype 上找:", Array.prototype.hasOwnProperty ? "❌ 没找到" : "❌ 没找到");  
console.log("3. 在 Object.prototype 上找:", Object.prototype.hasOwnProperty ? "✅ 找到了!" : "没找到");
...
这种设计让 JavaScript 的所有对象都有统一的基础行为，是面向对象编程的重要基础。理解这个继承体系对掌握 JavaScript 的对象系统至关重要。